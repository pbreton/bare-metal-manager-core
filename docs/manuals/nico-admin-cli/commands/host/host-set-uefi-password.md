# `nico-admin-cli host set-uefi-password`

*[Hardware commands](../../hardware.md) › [host](./host.md) › **set-uefi-password***

## NAME

nico-admin-cli-host-set-uefi-password - Set Host UEFI password

## SYNOPSIS

**nico-admin-cli host set-uefi-password** \<**-q**\|**--query**\>
